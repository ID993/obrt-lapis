      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-16 pb-16">
        <div>
          ...
          <div className="text-white/90 text-sm space-y-6 tracking-wider leading-relaxed font-light">
            ...
            <p>
              TIJEKOM GODINA PROŠIRILI SMO SPEKTAR USLUGA NA DIJAMANTNO BUŠENJE
              I VENTILACIJE, TE SMO ZAHVALJUJUĆI KVALITETI I POUZDANOSTI POSTALI
              PREPOZNATI MAJSTORI ZA VODOINSTALATERSKE RADOVE NA BRAČU.
            </p>
            {/* <p>
